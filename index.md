...
![](reference/figures/patient_profile_app.png)
...
Events.\
See
[`vignette("a00-papo")`](https://boehringer-ingelheim.github.io/dv.papo/articles/a00-papo.md)
for further information on how to use `dv.papo` with `dv.manager`.
